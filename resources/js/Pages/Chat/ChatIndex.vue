    ...
    <ChatLayout>
        <template #aside>
            ...
            <div class="flex justify-center mt-16">
                <Link
                    href="/profile"
                    class="text-white bg-gray-700 hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center w-60 justify-center"
                >
